...
public class SpiritWorldChunkGenerator extends ChunkGenerator {
    ...
    public static final Codec<SpiritWorldChunkGenerator> CODEC = RecordCodecBuilder.create((instance) ->
            instance.group(
                    ...
                    .apply(instance, instance.stable(SpiritWorldChunkGenerator::new))
    );

    public SpiritWorldChunkGenerator(BiomeSource biomeSource, boolean customBool) {
