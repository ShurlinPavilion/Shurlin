...
//        ORE_INFERIOR_SPIRIT_STONE = createOre("ore_inferior_spirit_stone", INFERIOR_SPIRIT_STONE_ORE_TARGETS, ShurlinConfiguredFeatures.States.INFERIOR_SPIRIT_STONE_ORE_BLOCK, 6, 6, 32);
        ORE_INFERIOR_SPIRIT_STONE = createOre("ore_inferior_spirit_stone", Feature.ORE.configure(new OreFeatureConfig(INFERIOR_SPIRIT_STONE_ORE_TARGETS, 6)).uniformRange(YOffset.getBottom(), YOffset.fixed(48)).spreadHorizontally().repeat(8),BiomeSelectors.foundInOverworld());
